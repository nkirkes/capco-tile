...
namespace CAPCO.Controllers
{
    public class ProductsController : ApplicationController
    {
            ...
            string description = "")
        {
            ...
            return specs.Any() ? productRepository.FindBySpecification(specs.ToArray()).OrderBy(x => x.ItemNumber) : productRepository.AllIncluding(x => x.Prices).OrderBy(x => x.ItemNumber);
        }
